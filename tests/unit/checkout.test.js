...
describe('checkout helpers', () => {
  ...
  describe('generateDemoReference', () => {
    it('produces a GH-prefixed alphanumeric checkout reference', () => {
      expect(generateDemoReference()).toMatch(/^GH-[A-Z0-9]{8}$/);
    });
  });
  ...
  describe('snapshotOrder', () => {
    it('captures a server-free order with item snapshots and totals', () => {
      const order = snapshotOrder({
        ...
        reference: 'GH-ABCD1234',
      });
      expect(order.reference).toBe('GH-ABCD1234');
