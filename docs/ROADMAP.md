...
- Source-default ranking enablement, behavior/popularity/hybrid production enablement, and learned/live collaborative integration remain separate decisions. Production uses explicit Profile B build/runtime flags for preference + exact feedback only. Neighborhood CF and classical SVD were rejected at NEXT-02; one biased-MF candidate was evaluated offline and rejected for live use. PERS-04 through PERS-08 stay behind default-off backend flags, and no live quality claim is made.
