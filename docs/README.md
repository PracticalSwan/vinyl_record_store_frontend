...
- `FUTURE_IMPLEMENTATION_PLAN.md`: completed FFP-01 through FFP-05 records plus approved artwork, admin, and demo-checkout plans and the cross-repository order.
