...
- Approved legacy release artwork has traceable source links and deterministic proxy -> bundled local JPEG -> placeholder fallbacks for all 116 records. The verified Amazon-derived v2 release has 208 strict accepted matches with a separate local JPEG set; ambiguous and unresolved rows use the placeholder. No Amazon image was copied.
