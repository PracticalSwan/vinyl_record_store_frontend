...
- PERS-00 through PERS-08 are complete for architecture, session-owned identity, default-off preference/behavior/popularity/hybrid presentation, and exact feedback controls. PERS-09 remains deferred; no quality claim is made.
