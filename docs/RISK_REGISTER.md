...
| FR-025 | Dataset products request unrelated legacy artwork or unreviewed Amazon images. | High | Gate local artwork by source, skip dataset products directly to the generic placeholder, and retain the reviewed three-stage chain only for legacy records. | controlled |
